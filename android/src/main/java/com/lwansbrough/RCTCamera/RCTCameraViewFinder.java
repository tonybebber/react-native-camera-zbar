...
class RCTCameraViewFinder extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    private boolean cameraIsRelease;
    ...
    public RCTCameraViewFinder(Context context, int type) {
        ...
        //zxing is used only for datamatrix
        reader = new DataMatrixReader();
        autoFocusCallback = new AutoFocusCallback();
        cameraIsRelease = false;
    }
                ...
                autofocusHandler = new Handler(){
                    ...
                    public void handleMessage(Message msg) {
                        if (msg.what == R.id.auto_focus)
                            postDelayed(autoFocusRunnable,2500);
                    }
    ...
    private class ReaderAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... ignored) {
            ...
            try {
                ...
                if( rawResult!=null){
                    if(rawResult.toString().length()==18){
    ...
    private void handleZoom(MotionEvent event, Camera.Parameters params) {
        ...
        if (RCTCamera.getInstance().isZoomEnabled()) {
            ...
            reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class).emit("ZoomComplete", callbackEvent);
        }
    }
            ...
            _camera.autoFocus(new Camera.AutoFocusCallback() {
                ...
                public void onAutoFocus(boolean success, Camera camera) {
                    if (success) {
                        ...
                        autofocusHandler.postDelayed(autoFocusRunnable,autoFocusCallback.AUTOFOCUS_INTERVAL_MS);
                    }
                }
            });
        }
