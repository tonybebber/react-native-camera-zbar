...
export class Camera extends Component {
  ...
  componentWillUnmount() {
    ...
    this._removeOnZoomChangesListener()
  ...
  _addOnZoomChangedListener(props) {
    ...
    this._removeOnZoomChangesListener()
    if (onZoomChanged) {
      this.zoomChangedListener = Platform.select({
          ios: NativeAppEventEmitter.addListener('ZoomComplete', this._onZoomChanged),
          android: DeviceEventEmitter.addListener('ZoomComplete', this._onZoomChanged),
      })
    }
  }
  _removeOnZoomChangesListener() {
